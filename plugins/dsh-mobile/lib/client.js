...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var STYLES = [
			...
			"     This pushes BOTH the session header (with its Chat/Trajectory tabs) and the",
			"     chat/trajectory content below the bar, so nothing is overlapped. */",
			"  [data-phase] { padding-top: 53px !important; box-sizing: border-box !important; }",
			"}",
