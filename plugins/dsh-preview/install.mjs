#!/usr/bin/env node
/**
 * Idempotent auto-install for the dsh-preview plugin. Run from the container
 ...
 * then inserts the `preview` row. The installer therefore does NOT hand-edit the
...
const e = (m) => process.stderr.write(`dsh-preview: ${m}\n`);
 ...
 * profile (e.g. one that carries an MCP client row or another plugin's rows),
