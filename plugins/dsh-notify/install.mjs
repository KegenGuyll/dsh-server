#!/usr/bin/env node
/**
 * Idempotent auto-install for the dsh-notify plugin. Run from the container
 ...
 * then inserts the `notify` row. The installer therefore does NOT hand-edit the
...
const e = (m) => process.stderr.write(`dsh-notify: ${m}\n`);
