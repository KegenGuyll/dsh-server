#!/usr/bin/env node
/**
 * Idempotent auto-install for the dsh-stt plugin. Run from the container
 ...
 * then inserts the `stt` row. The installer therefore does NOT hand-edit the
...
const PACKAGE = "dsh-stt";
const MARKER = join(PROFILE_DIR, `.${PACKAGE}.installed`);

const e = (m) => process.stderr.write(`dsh-stt: ${m}\n`);
